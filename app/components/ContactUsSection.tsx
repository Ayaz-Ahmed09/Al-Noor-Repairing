...
export function ContactUsSection() {
        ...
        return (
                <div className="w-full min-h-screen bg-black text-white flex flex-col items-center justify-center p-6 py-20 overflow-hidden relative">
                        ...
                        <div className="absolute top-0 left-1/4 w-160 h-160 bg-blue-900/10 rounded-full blur-[120px] pointer-events-none"></div>
                        <div className="absolute bottom-0 right-1/4 w-120 h-120 bg-indigo-900/10 rounded-full blur-[100px] pointer-events-none"></div>
                        ...
                        <div className="flex flex-col lg:flex-row gap-8 max-w-6xl w-full relative z-10">
                                ...
                                <div className="flex flex-col gap-6 w-full lg:w-1/3">
                                        <div className="bg-white/3 backdrop-blur-xl border border-white/10 p-8 rounded-3xl flex-1 shadow-2xl transition-all duration-300 hover:bg-white/[0.05] hover:border-blue-500/30 hover:shadow-[0_0_30px_rgba(59,130,246,0.15)] group">
                                                <h3 className="text-2xl font-bold mb-3 text-white">Call Us</h3>
                                                <p className="text-white/40 font-semibold text-lg drop-shadow-[0_0_10px_rgba(96,165,250,0.5)] group-hover:text-blue-300 transition-colors">
                                                        +971 00 000 0000
                                                </p>
                                        ...
                                        <div className="bg-white/3 backdrop-blur-xl border border-white/10 p-8 rounded-3xl flex-1 shadow-2xl transition-all duration-300 hover:bg-white/[0.05] hover:border-blue-500/30 hover:shadow-[0_0_30px_rgba(59,130,246,0.15)] group">
                                                ...
                                                <p className="text-white/40 font-semibold text-lg break-all drop-shadow-[0_0_10px_rgba(96,165,250,0.5)] group-hover:text-blue-300 transition-colors">
                                ...
                                {/* Form */}
                                <div className="w-full lg:w-2/3 bg-white/4 backdrop-blur-2xl border border-white/8 p-8 md:p-10 rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.4)] relative overflow-hidden">
                                        ...
                                        <div className="absolute -bottom-32 -left-32 w-64 h-64 bg-blue-600/10 rounded-full blur-[100px] pointer-events-none"></div>
